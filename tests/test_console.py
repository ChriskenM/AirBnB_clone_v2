...
class TestHBNBCommand(unittest.TestCase):
    ...
    def setUpClass(cls):
        """
        temporary renames file.json
        resets filestorage objects dictionary
        creates a command interpreter instance
        """
    ...
    def tearDownClass(cls):
        ...
        delete the HBNBCommand instance
        """
        ...
        if type(models.storage) == DBStorage:
            models.storage.__DBStorage__session.close()

    def setUp(self):
        """ reset filestorage dictionary """
    ...
    def test_create_with_kwargs(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            call = ('create place city_id="0021" name="The_house"
                    number_rooms=3 latitude=40.0 longitude=a')
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            ...
            self.AssertIn("'city_id': '0021'", output)
            self.AssertIn("'name': 'The_house'", output)
            self.AssertIn("'number_rooms': 3", output)
            self.AssertIn("'latitude': 40.0", output)
